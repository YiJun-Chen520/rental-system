    ...
    <script>
        ...
        function renderTable(list) {
            ...
            list.forEach(function(item) {
                ...
                html += '<button class="btn btn-danger btn-small" onclick="deleteOwner(' + item.id + ')">删除</button>';
                html += '</td>';
                html += '</tr>';
            });
        ...
        function toggleStatus(id, status) {
            ...
            if (!confirm('确定要' + statusText + '该房东吗？')) {
                return;
            }
