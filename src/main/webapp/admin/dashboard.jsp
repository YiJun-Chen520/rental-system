...
<head>
    ...
    <style>
        ...
        .stat-card:nth-child(6) .stat-icon { background: #e6fffb; color: #13c2c2; }
        .stat-card:nth-child(7) .stat-icon { background: #fcffe6; color: #a0d911; }
        .stat-card:nth-child(8) .stat-icon { background: #fff0f6; color: #eb2f96; }
...
<body>
    ...
    <div class="main-content">
        <div class="welcome-section">
            <h2>系统概览</h2>
            <p>欢迎使用房屋租赁管理系统管理端，以下是系统整体运行数据。</p>
        </div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value" id="totalOwners">--</div>
        ...
        function loadStats() {
            ...
            .then(function(result) {
                if (result.code === 200 && result.data) {
                    ...
                    document.getElementById('totalIncome').textContent = data.totalIncome ? ('¥' + data.totalIncome) : '¥0';
                } else {
